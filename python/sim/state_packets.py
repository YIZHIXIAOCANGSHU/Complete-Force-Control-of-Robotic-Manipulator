...
OUTPUT_TAU_OFFSET = 0
OUTPUT_REF_POS_OFFSET = OUTPUT_TAU_OFFSET + NUM_JOINTS
OUTPUT_REF_QUAT_OFFSET = OUTPUT_REF_POS_OFFSET + NUM_ARMS * 3
CONTROL_OUTPUT_PACKET_SIZE = OUTPUT_REF_QUAT_OFFSET + NUM_ARMS * 4
TORQUE_OUTPUT_PACKET_SIZE = CONTROL_OUTPUT_PACKET_SIZE
